...
fun manipulateString(str: String, int: Int): String {
    // String Input: "Dicoding000010"

    // Langkah 1: Mencari angka dalam string.
    val numberInString = str.filter { it.isDigit() }.toIntOrNull() ?: return str + int.toString()
    // Hasil dari langkah ini adalah pada variable numberInString = 10

    // Langka 2: Memisahkan bagian yang bukan angka.
    val nonNumberPart = str.filter { !it.isDigit() }
    // Hasil dari langkah ini adalah pada variabel nonNumberPart = "Dicoding"

    // Langkah 3: Mengalikan angka dengan integer jika ada, jika tidak, gabungkan dengan integer.
    val multipliedNumber = numberInString * int
    // Hasil dari langkah ini adalah variabel multipliedNumber = 1000 (10 * 100)

    // Langkah 4: Menggabungkan hasilnya dan kembalikan sebagai string.
    return nonNumberPart + multipliedNumber.toString()
    // Hasil akhir yang dikembalikan adalah "Dicoding" + "1000" = "Dicoding1000"
}
