...
//  Mengurutkan angka secara menurun lalu menyimpan di variable sortedNumbers
    val sortedNumbers = numbers.sortedDescending()

//  Mengambil tiga angka terbesar
    val topThreeNumber = sortedNumbers.take(3)

//  Menjumlahkan tiga angka terbesar
    val sumOfTopThreeNumbers = topThreeNumber.sum()

//  Mengembalikan hasilnya
    return sumOfTopThreeNumbers
}
